...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="col-lg-8 search_questions_form">
                <form name="form" method="POST" action="SearchQuestions.jsp">
                          <div class="form-group">
                                  <label for="firstName">Search Question</label>
                                  <input type="text" class="form-control" name="searchQuestion" id="searchQuestion">
        ...
        <%
            try {
                ...
                String strQuery1 = "SELECT * FROM FORUMUSER.QUESTIONS";
