    ...
    <body>
        ...
        <%
            try {
                ...
                int id_user = Integer.parseInt((request.getParameter("id_user").trim()));
                
                String strQuery1 = "SELECT * FROM FORUMUSER.QUESTIONS WHERE Id_User = "+id_user;
                ...
                while (result1.next()) {
                    ...
                    out.println("</form>");
                    out.println("<form name=\"form\" method=\"POST\" action=\"DeleteQuestionServlet\">");
                    out.println("<button type=\"submit\" id=\"view_more\" class=\"btn btn-primary\">Delete</button>");
                    out.println("<input type=\"hidden\" id=\"id_question\" name=\"id_question\" value=\""+ result1.getString("ID")+ " \">");
                    out.println("</form>");
                    out.println("</div>");
                }
